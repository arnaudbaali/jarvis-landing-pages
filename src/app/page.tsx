    ...
    <main className="min-h-screen bg-white text-black font-sans antialiased">
            ...
            {[
              {
                ...
                desc: "Drop in your cover image, paste your blurb, and add your genre + 2–3 comparable titles.",
              },
              {
                n: "02",
                title: "AI analyses click-worthiness",
                desc: "We score your cover against current bestsellers — thumbnail legibility, emotional tone, genre fit, and blurb hook strength.",
              },
              {
                n: "03",
                title: "Get a clear action report",
                desc: "Receive a scored report with specific, ranked changes. Know what to fix before you go live — not after.",
              },
            ].map((step) => (
      ...
      <section className="px-6 py-16 max-w-2xl mx-auto text-center">
        ...
        <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight mb-4">
          Stop paying Amazon to test your packaging.<br />Test it first.
        </h2>
        <p className="text-gray-500">
          Every book launch is a paid experiment. LaunchReady makes sure you&apos;re testing the right thing — the book&apos;s demand — not whether the cover converts.
        </p>
      </section>
      ...
      <section className="px-6 py-16 max-w-2xl mx-auto text-center">
        ...
        <div className="inline-block border border-gray-200 rounded-2xl p-8 text-left max-w-sm w-full">
          ...
          <a
            href="#waitlist"
            className="block w-full text-center px-6 py-3 bg-black text-white font-semibold rounded-lg hover:bg-gray-800 transition-colors text-sm"
          >
      ...
      <section id="waitlist" className="bg-black text-white px-6 py-20 text-center">
        ...
        <p className="text-gray-400 mb-8">
          Free while we&apos;re in beta. Be the first to know if your book is ready to sell.
        </p>
